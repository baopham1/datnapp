    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.startView}>
          ...
          <Text style={styles.textlist}>Gender</Text>
        </View>
        <View style={styles.endView}>
          <Text style={styles.textlistR}>Female</Text>
      ...
      >
        <View style={styles.startView}>
          ...
          <Text style={styles.textlist}>Birthday</Text>
        </View>
        <View style={styles.endView}>
          <Text style={styles.textlistR}>11-11-1111</Text>
          <MaterialIcons style={styles.iconsR} name="navigate-next" size={32} color="#4D5656" />
        </View>
      ...
      >
        ...
        <View style={styles.endView}>
          <Text style={styles.textlistR}>lalala@gmail.com</Text>
          <MaterialIcons style={styles.iconsR} name="navigate-next" size={32} color="#4D5656" />
        </View>
      ...
      >
        <View style={styles.startView}>
          ...
          <Text style={styles.textlist}>Phone Number</Text>
        </View>
        <View style={styles.endView}>
          <Text style={styles.textlistR}>010101010</Text>
          <MaterialIcons style={styles.iconsR} name="navigate-next" size={32} color="#4D5656" />
        </View>
      ...
      >
        <View style={styles.startView}>
          ...
          <Text style={styles.textlist}>Change Password</Text>
        </View>
        <View style={styles.endView}>
